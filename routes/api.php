...
Route::prefix('/v1')->group(function () {
    ...
    Route::group(['middleware' => ['jwt', 'jwt.auth']], function () {
        ...
        Route::post('profile/changePassword', [AuthController::class,'changePassword']);
        ...
        Route::post('favorite/getFavorite', [FavoriteController::class, 'getFavorites']);
        ...
        Route::post('products/getByPartnerId', [ProductsController::class, 'getByPartnerId']);
        ...
        Route::post('freelancer_services/getPartnerAll', [ServicesController::class, 'getPartnerAll']);
        ...
        Route::post('salon/getAppointmentsForSalon', [AppointmentsController::class, 'getAppointmentsForSalon']);
        ...
        Route::post('freelancer/getPartnerHome', [AuthController::class, 'getPartnerHome']);
        ...
        Route::post('chats/search', [ConversionsController::class, 'search']);
